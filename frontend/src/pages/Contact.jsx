...
const Contact = () => {
  return (
    ...
    <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-blue-800 rounded-lg">
    <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
        <div>
            ...
            <p class="text-xl text-gray-300 mt-4 leading-relaxed"> We'd love to hear about your project  and provide help.</p>
